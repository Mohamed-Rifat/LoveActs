...
import { FiCoffee, FiX, FiSearch, FiCheck } from "react-icons/fi";
import { motion } from "framer-motion";
import axios from "axios";

export default function ChooseCafe({ onSelectCafe, onSelectDrink, singleSelectionMode = false }) {
            ...
            filteredCafes.map((cafe) => (
              ...
              >
                ...
                <button
                  ...
                  className={`mt-2 flex items-center justify-center gap-1 py-1 px-3 rounded-xl transition-colors text-xs
        ...
        >
          ...
          >
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          {isSelected && (
                            <div className="absolute inset-0 bg-[#A85C68] bg-opacity-20 rounded-full flex items-center justify-center">
                              <FiCheck className="text-white bg-[#A85C68] rounded-full p-1" size={24} />
                            </div>
                          )}
                        </div>
                        <p
            ...
            <div className="p-4 border-t border-gray-200 flex justify-between bg-gray-50">
              <button
                onClick={handleClosePopup}
                className="px-4 py-2 text-gray-600 hover:text-gray-800 transition hover:bg-gray-100"
              >
                Close
              </button>
              <button
                ...
                className={`px-6 py-2 font-medium transition ${selectedDrink
                  ? "bg-[#CF848A] hover:bg-[#A85C68] text-white shadow-md transform"
                  : "bg-gray-300 text-gray-500 cursor-not-allowed"
                  }`}
              >
                {singleSelectionMode ? "Select Drink" : "Next"}
              </button>
            </div>
          </motion.div>
        </motion.div>
