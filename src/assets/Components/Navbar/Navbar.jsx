      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 container">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <Link
              to="/home"
              className="flex items-center space-x-2 text-gray-700 hover:text-[#CF848A] px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:scale-105"
            >
              <span>Home</span>
            </Link>
            <Link
            ...
            <Link
              to="/cart"
              className="relative flex items-center space-x-2 text-gray-700 hover:text-[#CF848A] transition-all duration-300"
            >
            ...
            <div className="flex items-center space-x-4 border-l border-gray-300 pl-4 ml-2">
            ...
            <div className="flex items-center space-x-4">
              {token ? (
                ...
                <Link
                  to="/login"
                  className="text-gray-700 hover:text-[#CF848A] px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:scale-105"
                >
                  Login
                </Link>
              )}
          ...
          <div className="lg:hidden flex items-center space-x-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-primary-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 ms-2"
